...
import bgimage from "../../assets/aibg.png";
    ...
    <div>
      ...
      >
        <div className="container mx-auto flex flex-col items-center px-4 py-16 text-center md:py-32 md:px-10 lg:px-32 xl:max-w-5xl">
          <motion.h1
            className="text-4xl font-bold text-blue-shade-5 leading-none sm:text-5xl"
          ...
          <motion.p
            className="px-8 mt-8 mb-4 text-[18px] text-blue-shade-5"
            initial={{ opacity: 0 }}
          ...
          <div className="container mx-auto py-16 px-4 sm:px-6 lg:px-8">
            <div className="grid grid-cols-1 md:grid-cols-2 items-center">
              <motion.div
                ...
                viewport={{ once: true }}
              >
                <p className="mt-4 text-gray-900 text-[18px] leading-8 text-justify">
                  ...
                  regulatory environment with mandates on data residency,
                  privacy, and usage.
                </p>
              </motion.div>
              <motion.div
      ...
      <div className="sticky top-0 flex flex-col items-center justify-center bg-gradient-to-b from-blue-shade-6/95 to-blue-shade-5 text-blue-shade-1 parallax-section">
        <motion.section
          initial={{ opacity: 0 }}
          whileInView={{ opacity: 1 }}
          transition={{ duration: 1.8 }}
      ...
      <div className="sticky  flex flex-col items-center justify-center bg-gradient-to-b from-blue-shade-5 to-blue-shade-6/95 text-blue-shade-1 parallax-section">
        <section>
              ...
              >
                ...
                <div className="max-w-[85%] mx-auto mt-8">
                  ...
                  <p className="mt-4 text-gray-900 text-[18px] text-justify">
                    ...
                    helping organizations in building AI & Data products. Our
                    consultants have experience of 10+ years while working with
                    multiple organizations and building the new age AI &
                    analytics products.
                  </p>
                </div>
              </motion.div>
            ...
            <div className="grid grid-cols-1 items-center">
              ...
              >
                ...
                <p className="mt-4 text-gray-900 text-[18px] text-justify">
                  ...
                  of images and videos. The common applications of computer
                  vision include image classification, object localization,
                  object detection, tag generation from images, semantic and
            ...
            <div className="grid grid-cols-1 items-center">
              ...
              >
                ...
                <p className="mt-4 text-gray-900 text-[18px] text-justify">
                  ...
                  customers, integrate these functionalities with client
                  products.
                </p>
              </motion.div>
            </div>
